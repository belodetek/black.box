...
2. download and uncompress the [.img](https://s3.eu-central-1.amazonaws.com/belodetech/resin-rpi3-1.16.0-2.3.0-46c05b958e51.img.gz) file, burn it to the SD card with `Etcher`, then insert the card into the Pi
